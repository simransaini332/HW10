...
//        }
       System.out.println();
        ...
        check2=((testBag8.remove().equals("check"))&&testBag8.getCurrentSize()==0);
        ...
        for (int i = 0; i < startSize; i++) {
            ...
            assertNotEquals(testBag9.getCurrentSize(),startSize-(i+1));
       ...
       System.out.println();
        ...
        for (int i = 0; i < startSize; i++) {
            ...
            System.out.println("Got item " + got);
             assertNotEquals(testBag11.getFrequencyOf("U") + testBag12.getFrequencyOf("U") ,5);
             failed = true;
            /*if (testBag11.getFrequencyOf("U") + testBag12.getFrequencyOf("U") != 5) {
             ...
             assertNotEquals(testBag11.getFrequencyOf("V") + testBag12.getFrequencyOf("V") ,5);
             failed = true;
           /* if (testBag11.getFrequencyOf("V") + testBag12.getFrequencyOf("V") != 5) {
             ...
             assertNotEquals(testBag11.getFrequencyOf("W") + testBag12.getFrequencyOf("W") ,5);
             failed = true;
           /* if (testBag11.getFrequencyOf("W") + testBag12.getFrequencyOf("W") != 5) {
             ...
             assertNotEquals(testBag11.getFrequencyOf("X") + testBag12.getFrequencyOf("X") ,5);
             failed = true;
            /*if (testBag11.getFrequencyOf("X") + testBag12.getFrequencyOf("X") != 5) {
             ...
             assertNotEquals(testBag11.getFrequencyOf("Y") + testBag12.getFrequencyOf("Y") ,5);
             failed = true;
           /* if (testBag11.getFrequencyOf("Y") + testBag12.getFrequencyOf("Y") != 5) {
             ...
             assertNotEquals(testBag11.getFrequencyOf("Z") + testBag12.getFrequencyOf("Z") ,5);
             failed = true;
